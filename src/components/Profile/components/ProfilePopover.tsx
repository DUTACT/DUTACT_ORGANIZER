...
export default function ProfilePopover({ onClosePopover, setIsShowProfilePopup }: ProfilePopover) {
  return (
    <div className='overflow-hidden rounded-md border border-neutral-3 shadow-custom'>
      ...
      <div className='flex cursor-pointer items-center gap-3 py-2 pl-2 pr-6 hover:bg-neutral-2'>
