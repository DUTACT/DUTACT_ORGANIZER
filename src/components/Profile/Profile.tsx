...
export default function Profile() {
  ...
  return (
    <Fragment>
      <Popover
        ...
        content={
          <div ref={setPopperElement} style={{ ...styles.popper, zIndex: 9999 }} {...attributes.popper}>
            <ProfilePopover onClosePopover={onClosePopover} setIsShowProfilePopup={setIsShowProfilePopup} />
          </div>
        }
      ...
      {isShowProfilePopup && <ProfilePopup setIsShowProfilePopup={setIsShowProfilePopup} />}
    </Fragment>
  )
}
